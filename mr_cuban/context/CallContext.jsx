...
export const CallProvider = ({ children }) => {
  ...
  const handleRejectCall = async () => {
    ...
    try {
      // Extract caller ID from channel name
      // For normal rides: channel format is order_{driverOrderId}
      // We need to get the driver ID who initiated the call
      // This will be passed when starting outgoing call
