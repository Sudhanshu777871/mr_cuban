...
const AudioCallModal = ({ visible, onClose, driverName, channelName, appId, isIncomingCall = false }) => {
    ...
    try {
      ...
      agoraEngine.registerEventHandler({
        onJoinChannelSuccess: () => {
          ...
          if (!isIncomingCall) {
            console.log("Waiting for driver to answer...");
          }
        },
        onUserJoined: (connection, uid) => {
          ...
          ToastAndroid.show(`${driverName} answered`, ToastAndroid.SHORT);
        },
